...
blocks:
  - body: >
      ...
      different level of services provided are indicated below. All experiments
      are carried out using raster scanning **30W Synrad CO2 Lasers** and the
      argon gas samples extracted are cleaned using customized **Thermo
      Scientific NG Prep Systems** and analyzed using one of two **Thermo
      Scientific ARGUS VI Multi-Collector Mass Spectrometers**.
    _template: content
  - color: default
  ...
  - body: >
      ...
      is delivered via email. This service includes **Full Mineral Separation**
      and **Acid Leaching** protocols.
    _template: content
  - color: default
    full_width: true
    column_headers:
  ...
  - body: >
      ...
      data report;  This service includes **Full Mineral Separation** and **Acid
      Leaching** protocols.
    _template: content
  - full_width: true
    column_headers:
