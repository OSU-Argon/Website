    ...
    rows:
      - columns:
          ...
          - body: |
              $75/hour
          - body: |
              Assistance provided to clients for the instruction of using the 

              ArArCALC data reduction and ArArSUITE data acquisition software 

              and the development of special/new features upon request.
      - columns:
          - body: |
              ### Technical Report Writing Fee
          - body: |
