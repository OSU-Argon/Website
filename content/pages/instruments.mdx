...
blocks:
  ...
  - body: >
      ...
      mounted next to the low mass 36 Faraday detector. This system is equipped
      with an 30 W Synrad Firestar v30 CO2 laser with industrial scan head for
      carrying out gas extractions. The ARGUS VI can be operated in three
      different modes:
      ...
      * **Combination Mode** whereby all masses will be measured simultaneously
      ...
      (one for air and one for an 38Ar spiked air standard).
      ...
      #### ARGUS-VI-G (more gettering power)


      Data is collected using ArArExperiments and all resulting ages are
      calculated using the [ArArCALC v2.7.0](http://earthref.org/ArArCALC/)
